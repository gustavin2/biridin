	...
	case 'hidetag':
              ...
              await client.sendMessage(from, options, text)
               break
					...
					break
                                case 'cmmd':
		if (args.length < 1) return reply ('exemplo de como se registrar: *daftar (seu nome|sua idade, exemplo: *daftar nabuto|14')
		break
				case 'snowwrite':
            ...
            break
					...
					case 'nsfwbobs': 
						try {
							...
							buffer = await getBuffer(res.url)
							client.sendMessage(from, buffer, image, {quoted: mek, caption: 'Taí os peitos que vc queria\npunhetero de merda'})
						} catch (e) {
							console.log(`Error :`, color(e,'red'))
							reply('❌ *ERROR* ❌')
						}
